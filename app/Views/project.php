                ...
                $.ajax({
                    ...
                    success: function() {
                        ...
                        for (k in mdlarray) {
                            ...
                            if (mdlarray[k]['denomination'] === '1') {
                                tdden.innerHTML = 'Unit';
                            } else if (mdlarray[k]['denomination'] === '2') {
                                tdden.innerHTML = 'Meter';
                            } else if (mdlarray[k]['denomination'] === '3') {
        ...
        <div class="uk-modal-dialog uk-margin-auto-vertical" uk-overflow-auto>
            ...
            <div class="uk-modal-body">
                <form class="uk-form-stacked" action="project/update/<?= $project['id'] ?>" method="post">
                    ...
                    <!-- Prosentase Produksi Section End -->
